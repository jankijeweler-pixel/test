...
const heroSlides = [
  {
    ...
    descriptionEn: "Adopt your own fruit tree from certified farms. Enjoy fresh harvests of mangoes, litchi, and more - delivered straight to your door.",
                        ...
                        onClick={() => {
                          if (slide.isWhatsApp) {
                            ...
                            const message = language === 'hi' 
                              ? 'नमस्ते! मैं पेड़ किराए पर लेना चाहता/चाहती हूं। कृपया जानकारी दें।'
